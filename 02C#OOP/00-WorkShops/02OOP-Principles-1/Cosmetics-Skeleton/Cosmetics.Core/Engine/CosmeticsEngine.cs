...
namespace Cosmetics.Core.Engine
{
    public sealed class CosmeticsEngine : IEngine
    {
        ...
        private const string CreamAlreadyExist = "Shampoo with name {0} already exists!";
        ...
        private string CreateCream(string creamName, string creamBrand, decimal creamPrice, GenderType creamGender, ScentType creamType)
        {
            ...
            var cream = this.factory.CreateCream(creamName, creamBrand, creamPrice, creamGender, creamType);
