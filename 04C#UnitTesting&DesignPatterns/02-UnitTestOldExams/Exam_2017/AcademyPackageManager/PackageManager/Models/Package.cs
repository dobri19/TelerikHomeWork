...
namespace PackageManager.Models
{
    public class Package : IPackage
    {
        ...
        //public int CalculateVersion(int major, int minor, int patch, VersionType versionType)
        //{
        //    return major * 1000 + minor * 100 + patch * 10 + (int)versionType;
        //}
        ...
        public int CompareTo(IPackage other)
        {
            ...
            //var thisFersionFinal = CalculateVersion(this.Version.Major, this.Version.Minor, this.Version.Patch, this.Version.VersionType);
            //var otherFersionFinal = CalculateVersion(other.Version.Major, other.Version.Minor, other.Version.Patch, other.Version.VersionType);
