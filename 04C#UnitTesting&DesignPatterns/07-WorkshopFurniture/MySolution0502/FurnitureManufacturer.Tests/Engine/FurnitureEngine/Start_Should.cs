...
namespace FurnitureManufacturer.Tests.Engine.FurnitureEngine
{
    [TestClass]
    public class Start_Should
    {
        ...
        public void CallCreateCommandFactory_WithCorrectCommandName()
        {
            ...
            var sut = new FurnitureManufacturer.Engine.FurnitureEngine(rendererStub.Object, factoryMock.Object);
            sut.Start();
        ...
        public void ExecuteCommand_WithCorrectCommandParameters()
        {
            ...
            var sut = new FurnitureManufacturer.Engine.FurnitureEngine(rendererStub.Object, factoryStub.Object);
            sut.Start();
        ...
        public void ReturnCorrectResultFromExecuteCommand_WithCorrectCommandParameters()
        {
            ...
            var sut = new FurnitureManufacturer.Engine.FurnitureEngine(rendererMock.Object, factoryStub.Object);
            sut.Start();
