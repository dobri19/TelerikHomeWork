namespace FurnitureManufacturer.Engine
{
    ...
    {
        // Commands
        public virtual string CreateCompanyCommand => "CreateCompany";
        public virtual string AddFurnitureToCompanyCommand => "AddFurnitureToCompany";
        public virtual string RemoveFurnitureFromCompanyCommand => "RemoveFurnitureFromCompany";
        public virtual string FindFurnitureFromCompanyCommand => "FindFurnitureFromCompany";
        public virtual string ShowCompanyCatalogCommand => "ShowCompanyCatalog";
        public virtual string CreateTableCommand => "CreateTable";
        public virtual string CreateChairCommand => "CreateChair";
        public virtual string SetChairHeight => "SetChairHeight";
        public virtual string ConvertChair => "ConvertChair";
